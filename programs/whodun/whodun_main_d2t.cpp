...
WhodunDataToTableProgram::WhodunDataToTableProgram() :
	textHeader("--head","Add Header","Whether the table should have a header line with the column names."),
	textHeadSigil("--sigil","Header Sigils","Whether the column names have sigils attached."),
	optTabIn(0,"--in","Input","The database to read in."),
	optDatOut(0,"--out","Output","The table to write to.")
{
	name = "d2t";
