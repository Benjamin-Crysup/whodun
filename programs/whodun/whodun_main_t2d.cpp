...
WhodunTableToDataProgram::WhodunTableToDataProgram() :
	textHeader("--head","Has Header","Whether the table has a header line with the column names."),
	textHeadSigil("--sigil","Has Sigils","Whether the column names have sigils attached."),
	optTabIn(0,"--in","Input","The table to read in."),
	optDatOut(0,"--out","Output","The database to write to.")
{
	name = "t2d";
