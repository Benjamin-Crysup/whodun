...
ArgumentOptionDataTableRead::ArgumentOptionDataTableRead(int needed, const char* longArg, const char* theName, const char* sumText) : ArgumentOptionFileRead(longArg, theName, sumText, (std::string(longArg) + " IN.dat").c_str()){
	required = needed;
...
ArgumentOptionDataTableRandac::ArgumentOptionDataTableRandac(int needed, const char* longArg, const char* theName, const char* sumText) : ArgumentOptionFileRead(longArg, theName, sumText, (std::string(longArg) + " DATA.dat").c_str()){
	required = needed;
	validExts.push_back(".bdat");
	validExts.push_back(".raw.bcdat");
	//validExts.push_back(".gzip.bcdat");
...
ArgumentOptionDataTableWrite::ArgumentOptionDataTableWrite(int needed, const char* longArg, const char* theName, const char* sumText) : ArgumentOptionFileWrite(longArg, theName, sumText, (std::string(longArg) + " OUT.dat").c_str()){
	required = needed;
	validExts.push_back(".bdat");
	validExts.push_back(".bdat.gz");
	validExts.push_back(".bdat.gzip");
