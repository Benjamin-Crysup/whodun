...
ArgumentOptionTextTableRead::ArgumentOptionTextTableRead(int needed, const char* longArg, const char* theName, const char* sumText) : ArgumentOptionFileRead(longArg, theName, sumText, (std::string(longArg) + " IN.tsv").c_str()){
	required = needed;
...
ArgumentOptionTextTableRandac::ArgumentOptionTextTableRandac(int needed, const char* longArg, const char* theName, const char* sumText) : ArgumentOptionFileRead(longArg, theName, sumText, (std::string(longArg) + " DATA.zlib.bctab").c_str()){
	required = needed;
	validExts.push_back(".raw.bctab");
	//validExts.push_back(".gzip.bctab");
	validExts.push_back(".zlib.bctab");
...
ArgumentOptionTextTableWrite::ArgumentOptionTextTableWrite(int needed, const char* longArg, const char* theName, const char* sumText) : ArgumentOptionFileWrite(longArg, theName, sumText, (std::string(longArg) + " OUT.tsv").c_str()){
	required = needed;
	validExts.push_back(".tsv");
	validExts.push_back(".tsv.gz");
	validExts.push_back(".tsv.gzip");
