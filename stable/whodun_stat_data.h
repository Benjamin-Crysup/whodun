...
public:
	 ...
	 */
	ArgumentOptionDataTableRead(int needed, const char* longArg, const char* theName, const char* sumText);
	/**Tear down.*/
...
public:
	 ...
	 * @param sumText A summary of the argument.
	 */
	ArgumentOptionDataTableRandac(int needed, const char* longArg, const char* theName, const char* sumText);
	/**Tear down.*/
...
public:
	 ...
	 * @param sumText A summary of the argument.
	 */
	ArgumentOptionDataTableWrite(int needed, const char* longArg, const char* theName, const char* sumText);
	/**Tear down.*/
