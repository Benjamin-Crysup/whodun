...
public:
	 ...
	 */
	ArgumentOptionTextTableRead(int needed, const char* longArg, const char* theName, const char* sumText);
	/**Tear down.*/
...
public:
	 ...
	 * @param sumText A summary of the argument.
	 */
	ArgumentOptionTextTableRandac(int needed, const char* longArg, const char* theName, const char* sumText);
	/**Tear down.*/
...
public:
	 ...
	 * @param sumText A summary of the argument.
	 */
	ArgumentOptionTextTableWrite(int needed, const char* longArg, const char* theName, const char* sumText);
	/**Tear down.*/
