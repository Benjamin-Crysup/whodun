...
void ArgumentOption::dumpCommonInfo(OutStream* toStr, uintptr_t numExtra){
	...
	//sigils
		packI.retarget(intDump); packI.packBE64(sigils.size()); toStr->write(intDump, 8);
		for(uintptr_t i = 0; i<sigils.size(); i++){
			packI.retarget(intDump); packI.packBE64(sigils[i].size()); toStr->write(intDump, 8);
			toStr->write(sigils[i].c_str(), sigils[i].size());
		}
	//summary
...
int ArgumentOptionNamed::canParse(uintptr_t argc, char** argv){
	for(uintptr_t i = 0; i<sigils.size(); i++){
		if(strcmp(argv[0], sigils[i].c_str())==0){ return 1; }
	}
	return 0;
}

ArgumentOptionFlag::ArgumentOptionFlag(const char* longArg, const char* theName, const char* sumText) : ArgumentOptionNamed(){
	value = 0;
	name = theName;
	sigils.push_back(longArg);
	summary = sumText;
	typeCode = "flag";
	extTypeCode = "";
}
...
ArgumentOptionEnum::ArgumentOptionEnum(const char* longArg, const char* theName, const char* sumText, ArgumentOptionEnumValue* forClass) : ArgumentOptionNamed(){
	myClass = forClass;
...
ArgumentOptionInteger::ArgumentOptionInteger(const char* longArg, const char* theName, const char* sumText, const char* useText) : ArgumentOptionNamed(){
	value = 0;
	name = theName;
	sigils.push_back(longArg);
	summary = sumText;
...
ArgumentOptionIntegerVector::ArgumentOptionIntegerVector(const char* longArg, const char* theName, const char* sumText, const char* useText) : ArgumentOptionNamed(){
	name = theName;
	sigils.push_back(longArg);
	summary = sumText;
	usage = useText;
...
ArgumentOptionFloat::ArgumentOptionFloat(const char* longArg, const char* theName, const char* sumText, const char* useText) : ArgumentOptionNamed(){
	value = 0;
	name = theName;
	sigils.push_back(longArg);
	summary = sumText;
...
ArgumentOptionFloatVector::ArgumentOptionFloatVector(const char* longArg, const char* theName, const char* sumText, const char* useText) : ArgumentOptionNamed(){
	name = theName;
	sigils.push_back(longArg);
	summary = sumText;
	usage = useText;
...
ArgumentOptionString::ArgumentOptionString(const char* longArg, const char* theName, const char* sumText, const char* useText) : ArgumentOptionNamed(){
	name = theName;
	sigils.push_back(longArg);
	summary = sumText;
	usage = useText;
...
ArgumentOptionStringVector::ArgumentOptionStringVector(const char* longArg, const char* theName, const char* sumText, const char* useText) : ArgumentOptionNamed(){
	name = theName;
	sigils.push_back(longArg);
	summary = sumText;
	usage = useText;
...
ArgumentOptionThreadcount::ArgumentOptionThreadcount() : ArgumentOptionInteger("--thread","Number of Threads","The number of threads to spin up.","--thread 1"){
	value = 1;
}
...
ArgumentOptionThreadgrain::ArgumentOptionThreadgrain() : ArgumentOptionInteger("--threadgrain","Thread Grain","The number of things each thread should do at a time.","--threadgrain 65536"){
	value = 0x010000;
}
...
ArgumentOptionFileRead::ArgumentOptionFileRead(const char* longArg, const char* theName, const char* sumText, const char* useText) : ArgumentOptionString(longArg,theName,sumText,useText){
...
ArgumentOptionFileWrite::ArgumentOptionFileWrite(const char* longArg, const char* theName, const char* sumText, const char* useText) : ArgumentOptionString(longArg,theName,sumText,useText){
...
ArgumentOptionFileReadVector::ArgumentOptionFileReadVector(const char* longArg, const char* theName, const char* sumText, const char* useText) : ArgumentOptionStringVector(longArg,theName,sumText,useText){
	extTypeCode = "fileread";
}
...
ArgumentOptionFileWriteVector::ArgumentOptionFileWriteVector(const char* longArg, const char* theName, const char* sumText, const char* useText) : ArgumentOptionStringVector(longArg,theName,sumText,useText){
	extTypeCode = "filewrite";
}
...
ArgumentOptionFolderRead::ArgumentOptionFolderRead(const char* longArg, const char* theName, const char* sumText, const char* useText) : ArgumentOptionString(longArg,theName,sumText,useText){
...
ArgumentOptionFolderWrite::ArgumentOptionFolderWrite(const char* longArg, const char* theName, const char* sumText, const char* useText) : ArgumentOptionString(longArg,theName,sumText,useText){
