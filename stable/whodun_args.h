...
public:
	...
	std::string name;
	/**Any texts that will trigger this option.*/
...
public:
	/**
	 * Set up.
	 * @param longArg The basic form of the argument.
	 * @param theName The name of the argument.
	 * @param sumText A summary of the argument.
	 */
	ArgumentOptionFlag(const char* longArg, const char* theName, const char* sumText);
	/**Tear down.*/
	~ArgumentOptionFlag();
	uintptr_t parse(uintptr_t argc, char** argv, StandardProgram* forProg);
...
public:
	 ...
	 */
	ArgumentOptionEnum(const char* longArg, const char* theName, const char* sumText, ArgumentOptionEnumValue* forClass);
	/**Clean up.*/
	~ArgumentOptionEnum();
	uintptr_t parse(uintptr_t argc, char** argv, StandardProgram* forProg);
	/**
...
public:
	 ...
	 */
	ArgumentOptionInteger(const char* longArg, const char* theName, const char* sumText, const char* useText);
	/**Tear down.*/
...
public:
	 ...
	 * @param useText An example usage.
	 */
	ArgumentOptionIntegerVector(const char* longArg, const char* theName, const char* sumText, const char* useText);
	/**Tear down.*/
...
public:
	 ...
	 * @param useText An example usage.
	 */
	ArgumentOptionFloat(const char* longArg, const char* theName, const char* sumText, const char* useText);
	/**Tear down.*/
	~ArgumentOptionFloat();
	uintptr_t parse(uintptr_t argc, char** argv, StandardProgram* forProg);
	void dumpInfo(OutStream* toStr);
...
public:
	 ...
	 * @param useText An example usage.
	 */
	ArgumentOptionFloatVector(const char* longArg, const char* theName, const char* sumText, const char* useText);
	/**Tear down.*/
...
public:
	 ...
	 * @param useText An example usage.
	 */
	ArgumentOptionString(const char* longArg, const char* theName, const char* sumText, const char* useText);
	/**Tear down.*/
...
public:
	 ...
	 * @param useText An example usage.
	 */
	ArgumentOptionStringVector(const char* longArg, const char* theName, const char* sumText, const char* useText);
	/**Tear down.*/
...
public:
	 ...
	 * @param useText An example usage.
	 */
	ArgumentOptionFileRead(const char* longArg, const char* theName, const char* sumText, const char* useText);
	/**Tear down.*/
...
public:
	 ...
	 * @param useText An example usage.
	 */
	ArgumentOptionFileWrite(const char* longArg, const char* theName, const char* sumText, const char* useText);
	/**Tear down.*/
...
public:
	 ...
	 * @param useText An example usage.
	 */
	ArgumentOptionFileReadVector(const char* longArg, const char* theName, const char* sumText, const char* useText);
	/**Tear down.*/
...
public:
	 ...
	 * @param useText An example usage.
	 */
	ArgumentOptionFileWriteVector(const char* longArg, const char* theName, const char* sumText, const char* useText);
	/**Tear down.*/
...
public:
	 ...
	 * @param useText An example usage.
	 */
	ArgumentOptionFolderRead(const char* longArg, const char* theName, const char* sumText, const char* useText);
	/**Tear down.*/
...
public:
	 ...
	 * @param useText An example usage.
	 */
	ArgumentOptionFolderWrite(const char* longArg, const char* theName, const char* sumText, const char* useText);
	/**Tear down.*/
